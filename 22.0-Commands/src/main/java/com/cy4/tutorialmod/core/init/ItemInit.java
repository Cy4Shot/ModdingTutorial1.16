...
public class ItemInit {
	...
	public static final RegistryObject<CustomSpawnEggItem> EXAMPLE_SPAWN_EGG = ITEMS.register("example_spawn_egg",
			() -> new CustomSpawnEggItem(EntityTypesInit.EXAMPLE, 0x20d651, 0x8216e0,
